...
* **Media Manager: Local Media tab.** Crop, resize, rename and delete images before they're
  ...
  ([gh-36](https://github.com/grafida/grafida/issues/36)).
* **Custom fields of type Media** can now be edited using Grafida's own media browser — site media
  ...
  ([gh-59](https://github.com/grafida/grafida/issues/59)).
* **Sites:** choose which Media Manager filesystem and folder a published article's images are
  uploaded to ([gh-57](https://github.com/grafida/grafida/issues/57)), and say whether the site
  uses Unicode Aliases for tokens that can't read it from Global Configuration
  ([gh-61](https://github.com/grafida/grafida/issues/61)). The article alias is now transliterated
...
* **Diagnose Connection and an optional Request Log.** See the exact request and response when a
  ...
  ([gh-37](https://github.com/grafida/grafida/issues/37)).
* **Light / dark / follow-system switch in the sidebar**, so you can change the interface theme
  without leaving the open article ([gh-41](https://github.com/grafida/grafida/issues/41)).
* **In-editor image tools.** Right-click an image for Edit image (crop/resize/rotate/flip a local
  ...
  image not yet published ([gh-43](https://github.com/grafida/grafida/issues/43)).
* **Built-in Help screen**, with the same documentation also published on Grafida.app
  ([gh-55](https://github.com/grafida/grafida/issues/55)).
...
* The Read More separator of an article written in Joomla was invisible in the editor, and lost on
  publishing ([gh-71](https://github.com/grafida/grafida/issues/71)).
* **macOS 14 Sonoma:** the application quit instantly, with no window and no error message
  ([gh-58](https://github.com/grafida/grafida/issues/58)).
...
* Editor content stuck in dark mode when the site's `editor.css` switches on
  `prefers-color-scheme` ([gh-38](https://github.com/grafida/grafida/issues/38)).
* The editor showed every custom field the site has, not just the ones the article's category
  ...
  ([gh-56](https://github.com/grafida/grafida/issues/56)).
...
| Platform | Download |
| --- | --- |
| macOS (Apple Silicon) | [`Grafida-0.3-macos-arm64.dmg`](https://github.com/grafida/grafida/releases/download/0.3/Grafida-0.3-macos-arm64.dmg) |
| macOS (Intel) | [`Grafida-0.3-macos-amd64.dmg`](https://github.com/grafida/grafida/releases/download/0.3/Grafida-0.3-macos-amd64.dmg) |
| Windows (x64) | [`Grafida-0.3-windows-amd64-Setup.exe`](https://github.com/grafida/grafida/releases/download/0.3/Grafida-0.3-windows-amd64-Setup.exe) |
| Linux (x64) | [`Grafida-0.3-linux-amd64.tar.gz`](https://github.com/grafida/grafida/releases/download/0.3/Grafida-0.3-linux-amd64.tar.gz) |
| Linux (ARM64) | [`Grafida-0.3-linux-arm64.tar.gz`](https://github.com/grafida/grafida/releases/download/0.3/Grafida-0.3-linux-arm64.tar.gz) |
| Any (PHAR) | [`Grafida-0.3.phar`](https://github.com/grafida/grafida/releases/download/0.3/Grafida-0.3.phar) |
